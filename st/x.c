...
void cyclefonts(const Arg *inp){
	if(inp->i == 1)  fonts_current++;
	else if(inp->i == -1) fonts_current--;
	else if(inp->i == 0)  fonts_current=0;
	else fonts_current++;
	//fonts_current++;
	...
	else if (fonts_current < 0) {
		fonts_current = (sizeof fonts / sizeof(char*)) - 1;
	}
