...
static char *fonts[] = {
	"mono:pixelsize=6:antialias=true:autohint=true",
	"mono:pixelsize=9:antialias=true:autohint=true",
	"mono:pixelsize=11:antialias=true:autohint=true",
	...
	"mono:pixelsize=19:antialias=true:autohint=true",
	"mono:pixelsize=22:antialias=true:autohint=true",
	"mono:pixelsize=25:antialias=true:autohint=true",
};
static int fonts_current = 3;

static char *font2[] = { "wqy-zenhei:pixelsize=12", "JoyPixels:pixelsize=13:antialias=true:autohint=true" };
...
/* bg opacity */
//use xcompmgr to enable transparent
float alpha = 0.9;

/* Terminal colors (16 first used in escape sequence) */
static const char *colorname[] = {
	"#1d2021", /* hard contrast: #1d2021 / 282828 soft contrast: #32302f */
	"#cc241d",			//red
	"#22dd22",			//green
	"#ffbb00",			//yellow
	"#3388dd",			//blue
...
static Shortcut shortcuts[] = {
	...
	//{ 1,               		43,        cyclefonts,     {.i =  1} },				//this will work, but for any plus
	//{ MODKEY|ShiftMask,     XK_plus,        cyclefonts,     {.i =  1} },
	{ MODKEY,     			XK_minus,       cyclefonts,     {.i =  -1} },
	{ MODKEY,     			XK_equal,       cyclefonts,     {.i =  +1} },
	...
	{ MODKEY,               XK_Page_Up,     kscrollup,      {.i = 2} },
	{ MODKEY,               XK_Page_Down,   kscrolldown,    {.i = 2} },
